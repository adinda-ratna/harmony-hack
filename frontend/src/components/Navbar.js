    ...
    useEffect(() => {
        if (error && error.name === "UnsupportedChainIdError" && !locked) {
            ...
            add({
                ...
                content: <div>Please switch to Harmony Testnet</div>
            })
        }
    }, [error, locked])
            ...
            <Wrapper color="transparent" light expand="md">
                ...
                <Container>
                    <NavbarBrand>
                        ...
                        {chainId === 1666700000 && (<Badge size="sm" color="secondary">Harmony Testnet</Badge>)}
                    ...
                    <Collapse isOpen={isOpen} navbar>
                        <Nav className="ml-auto" navbar>
                            ...
                            <NavItem>
                                <NavLink>
                                    <a target="_blank"  href="https://github.com/FortEVE-Team/harmony-hack">Source Code</a>
                                </NavLink>
                            </NavItem>
                            {!account
                                ?
