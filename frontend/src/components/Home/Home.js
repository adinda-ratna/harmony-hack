        ...
        return (
            <div className={className}>
                <div>
                    <h3>Live Market</h3>
                    <p>
                        TEBS allows trade any major stock market indices up to 10x leverage via perpetual swap contracts using UST (Mock Terra UST) as a collateral on Harmony One Chain.
                    </p>
                </div>
            </div>
        )
    ...
    return (
        <Wrapper>
            ...
            <div style={{ padding: 20, paddingBottom: 0, textAlign: "center" }}>
                <Alert color="primary">
                    <AlertTriangle size={18} /> Please note that we're live only on Harmony Testnet at the moment, make sure you're connected to the correct network.
            </Alert>
            </div>
